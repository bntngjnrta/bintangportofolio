...
export {}
declare global {
  const AboutMeProfile: typeof import('./components/apps/AboutMeProfile')['default']
  const AboutThisMacModal: typeof import('./components/AboutThisMacModal')['default']
  const AchievementsProfile: typeof import('./components/apps/AchievementsProfile')['default']
  ...
  const PDFViewer: typeof import('./components/PDFViewer')['default']
  const PdfIcon: typeof import('./components/DesktopIcons')['PdfIcon']
  const Photos: typeof import('./components/apps/Photos')['default']
  const ProjectsProfile: typeof import('./components/apps/ProjectsProfile')['default']
  ...
  const projectsList: typeof import('./components/apps/ProjectsProfile')['projectsList']
