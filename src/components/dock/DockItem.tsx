...
export default function DockItem({
  ...
  return (
    <li
      ...
      className={`relative flex flex-col items-center ${isBouncing ? "dock-bounce" : ""
        }`}
      style={{
            ...
            style={
              winWidth < 640
                ? {
                  ...
                  backgroundColor: id === "skill-exchange" ? "#000" : "#fff",
                  boxShadow:
                    "inset 0 0 0 1px rgba(0,0,0,0.1), 0 2px 4px rgba(0,0,0,0.12)",
                  overflow: "hidden",
                }
                : {
                  width,
