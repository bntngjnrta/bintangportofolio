...
const CONVERSATIONS: Conversation[] = [
  ...
  },
  {
    ...
    name: "Ibu",
    avatar: "👩",
    preview: "Bintang, makanannya sudah siap ya",
    time: "1h",
    messages: [
      { id: "1", text: "Bintang, makanannya sudah siap ya", from: "them", time: "8:00 AM" },
      { id: "2", text: "Iya Bu, 5 menit lagi ya 😅", from: "me", time: "8:02 AM" },
    ],
  },
  {
    id: "4",
    ...
    time: "3h",
    messages: [
      { id: "1", text: "⭐ bntngjnrta/macOS-Portfolio received a new star!", from: "them", time: "7:00 AM" },
