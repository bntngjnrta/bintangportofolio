...
// Bintang resume context for conversational answers 
const BINTANG_INFO = `Kadek Bintang Januarta is an Informatics Management student at ASTRA Polytechnic with a strong passion for software engineering, full stack development, and system analysis.
Experienced in developing applications for web, mobile, and desktop platforms through end-to-end academic projects, including system requirement analysis and application design.
Skilled in problem solving, critical thinking, and collaborative development to deliver efficient, scalable, and user-focused software solutions.
Contact: Email kadekbintangjanuarta@gmail.com | GitHub @bntngjnrta | LinkedIn: kadek-bintang-januarta | Instagram: @bntngjnrta
His resume is available for download.`;

const SIRI_FALLBACK = "Hey, I appreciate the curiosity! But I can only perform actions that Bintang has set up for me. He built me to help navigate his portfolio — try asking me to open an app, play music, toggle dark mode, or check the time!";

const SYSTEM_PROMPT = `You are Siri, a friendly and chill virtual assistant running inside Kadek Bintang Januarta's macOS-style web portfolio.
...
Here is info about Bintang (use this when someone asks about him or his resume):
${BINTANG_INFO}

IMPORTANT RULES:
1. If you don't understand the request, or it is unrelated to the portfolio, reply EXACTLY: "${SIRI_FALLBACK}"
2. If asked about Bintang, his skills, experience, resume, or background — ALWAYS call the download_resume tool AND in your reply, share a brief friendly summary about Bintang (mention he's an Informatics Management student at ASTRA Polytechnic with a strong passion for software engineering, full stack development, and system analysis). Make it sound like you're genuinely proud of him!
...
6. You can open the launchpad to show Bintang's projects, open apps, toggle fullscreen, and more.
7. Never say "I am Bintang" — you are Siri, built BY Bintang.`;
...
const TOOLS = [
  ...
  { type: "function", function: { name: "download_resume", description: "Downloads Bintang's resume PDF. Call this whenever the user asks about Bintang, his background, skills, experience, or wants to see his resume." } },
  { type: "function", function: { name: "open_launchpad", description: "Opens the Launchpad overlay to show Bintang's projects." } },
...
export default function Siri({ closeSiri }: { closeSiri?: () => void }) {
  ...
  const downloadResume = useCallback(() => {
    ...
    link.download = "Kadek_Bintang_Januarta_Resume.pdf";
    link.target = "_blank";
  ...
  const executeTool = useCallback(async (name: string, args: any): Promise<string> => {
    ...
    switch (name) {
      ...
      case "download_resume":
        downloadResume();
        return "Here's Bintang's resume! He's a super talented full-stack dev and informatics management student. The download should start right up!";
      ...
      case "open_launchpad": {
        ...
        return "Opening up the Launchpad! Check out Bintang's cool projects.";
      }
